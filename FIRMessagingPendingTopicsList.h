...
- (BOOL)subscriptionErrorIsRecoverable:(id)arg1;
- (void)resumeOperationsIfNeeded;
- (void)addOperationForTopic:(id)arg1 withAction:(int)arg2 completion:(CDUnknownBlockType)arg3;
@property(readonly, nonatomic) unsigned int numberOfBatches;
