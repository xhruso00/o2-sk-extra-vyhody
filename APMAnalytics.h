...
+ (void)userPropertiesIncludingInternal:(BOOL)arg1 queue:(id)arg2 callback:(CDUnknownBlockType)arg3;
...
+ (id)eventsToLogWithEventID:(long long)arg1 origin:(id)arg2 isPublic:(BOOL)arg3 name:(id)arg4 timestamp:(double)arg5 parameters:(id)arg6;
+ (void)logEventOnSerialQueueWithOrigin:(id)arg1 isPublicEvent:(BOOL)arg2 name:(id)arg3 parameters:(id)arg4 timestamp:(double)arg5 ignoreEnabled:(BOOL)arg6 ignoreInterceptor:(BOOL)arg7 addedScreenParameters:(id)arg8;
...
+ (void)logEventsOnWorkerQueue:(id)arg1 notifyEventListeners:(BOOL)arg2;
...
+ (void)setAnalyticsEnabled:(BOOL)arg1 persistSetting:(BOOL)arg2;
