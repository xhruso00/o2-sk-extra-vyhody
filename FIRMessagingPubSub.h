...
- (BOOL)pendingTopicsListCanRequestTopicUpdates:(id)arg1;
- (void)pendingTopicsListDidUpdate:(id)arg1;
- (void)pendingTopicsList:(id)arg1 requestedUpdateForTopic:(id)arg2 action:(int)arg3 completion:(CDUnknownBlockType)arg4;
