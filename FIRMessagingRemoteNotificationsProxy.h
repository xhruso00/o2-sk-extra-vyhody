...
{
    BOOL _didSwizzleMethods;
    BOOL _didSwizzleAppDelegateMethods;
    BOOL _hasSwizzledUserNotificationDelegate;
    BOOL _isObservingUserNotificationDelegateChanges;
...
@property(nonatomic) BOOL isObservingUserNotificationDelegateChanges; // @synthesize isObservingUserNotificationDelegateChanges=_isObservingUserNotificationDelegateChanges;
@property(nonatomic) BOOL hasSwizzledUserNotificationDelegate; // @synthesize hasSwizzledUserNotificationDelegate=_hasSwizzledUserNotificationDelegate;
@property(nonatomic) BOOL didSwizzleAppDelegateMethods; // @synthesize didSwizzleAppDelegateMethods=_didSwizzleAppDelegateMethods;
@property(nonatomic) BOOL didSwizzleMethods; // @synthesize didSwizzleMethods=_didSwizzleMethods;
