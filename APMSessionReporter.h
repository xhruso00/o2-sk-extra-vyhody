...
@property(nonatomic, getter=isReportingEnabled) BOOL reportingEnabled; // @synthesize reportingEnabled=_reportingEnabled;
- (void).cxx_destruct;
...
- (void)logUserEngagementEventWithScreen:(id)arg1 isRedundant:(BOOL)arg2;
