...
@interface APMSearchAdReporter : NSObject
{
    ...
    BOOL _searchAdReporterEnabled;
}

@property(nonatomic, getter=isSearchAdReporterEnabled) BOOL searchAdReporterEnabled; // @synthesize searchAdReporterEnabled=_searchAdReporterEnabled;
- (void).cxx_destruct;
- (void)lookUpAdConversionDetails;
- (void)logCampaignEventWithSearchAdCampaign:(BOOL)arg1 campaign:(id)arg2 term:(id)arg3;
- (id)adClientInstance;
