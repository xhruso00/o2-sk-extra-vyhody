...
@interface Fabric : NSObject
{
    ...
    unsigned int _installationMode;
...
+ (void)setCrashlyticsCollectionEnabled:(BOOL)arg1;
...
@property(nonatomic) unsigned int installationMode; // @synthesize installationMode=_installationMode;
...
- (BOOL)setFirebaseGoogleAppIdFromUserInfo:(id)arg1;
