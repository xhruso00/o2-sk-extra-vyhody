...
@property(readonly, nonatomic, getter=isSessionScoped) BOOL sessionScoped; // @synthesize sessionScoped=_sessionScoped;
...
- (void).cxx_destruct;
- (id)initWithAudienceID:(int)arg1 filterID:(int)arg2 propertyName:(id)arg3 data:(id)arg4 sessionScoped:(BOOL)arg5;
