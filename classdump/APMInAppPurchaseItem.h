...
@property(nonatomic, getter=isIntroductoryOffer) BOOL introductoryOffer; // @synthesize introductoryOffer=_introductoryOffer;
@property(nonatomic, getter=isFreeTrial) BOOL freeTrial; // @synthesize freeTrial=_freeTrial;
- (void).cxx_destruct;
