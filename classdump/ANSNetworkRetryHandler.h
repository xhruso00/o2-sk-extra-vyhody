...
- (void)handleCompletedRequest:(id)arg1 withResponse:(id)arg2 forIdentifier:(id)arg3 maxRetries:(unsigned int)arg4 error:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;
