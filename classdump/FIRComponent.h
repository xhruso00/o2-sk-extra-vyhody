...
+ (id)componentWithProtocol:(id)arg1 instantiationTiming:(int)arg2 dependencies:(id)arg3 creationBlock:(CDUnknownBlockType)arg4;
...
@property(readonly, nonatomic) int instantiationTiming; // @synthesize instantiationTiming=_instantiationTiming;
@property(readonly, nonatomic) Protocol *protocol; // @synthesize protocol=_protocol;
- (void).cxx_destruct;
- (id)initWithProtocol:(id)arg1 instantiationTiming:(int)arg2 dependencies:(id)arg3 creationBlock:(CDUnknownBlockType)arg4;
