...
#import "FIRMessagingDataMessageManagerDelegate.h"

@class GULUserDefaults, NSString;

@interface FIRMessagingReceiver : NSObject <FIRMessagingDataMessageManagerDelegate>
{
    id <FIRMessagingReceiverDelegate> _delegate;
    GULUserDefaults *_defaults;
}

+ (id)nextMessageID;
@property(retain, nonatomic) GULUserDefaults *defaults; // @synthesize defaults=_defaults;
@property(nonatomic) __weak id <FIRMessagingReceiverDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
@property(nonatomic) BOOL useDirectChannel;
