...
#import "FIRInstanceIDInstanceProvider.h"
#import "FIRLibrary.h"
...
@property(nonatomic) int retryCountForDefaultToken; // @synthesize retryCountForDefaultToken=_retryCountForDefaultToken;
...
@property(nonatomic) int apnsTokenType; // @synthesize apnsTokenType=_apnsTokenType;
...
- (void)defaultTokenWithRetry:(BOOL)arg1 handler:(CDUnknownBlockType)arg2;
