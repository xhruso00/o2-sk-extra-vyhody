...
#import "GULNetworkLoggerDelegate.h"
...
@interface APMMeasurement : NSObject <GULNetworkLoggerDelegate, GULNetworkReachabilityDelegate>
{
    ...
    // Error parsing type: AI, name: _backgroundUpdateTask
...
+ (void)initializeSharedInstanceWithAppID:(id)arg1 isAnalyticsCollectionEnabled:(BOOL)arg2 isAnalyticsCollectionDeactivated:(BOOL)arg3 safelistedEvents:(id)arg4;
@property(nonatomic) BOOL isAnalyticsCollectionDeactivated; // @synthesize isAnalyticsCollectionDeactivated=_isAnalyticsCollectionDeactivated;
@property(nonatomic) BOOL isAnalyticsCollectionEnabled; // @synthesize isAnalyticsCollectionEnabled=_isAnalyticsCollectionEnabled;
@property(readonly, nonatomic) BOOL wasEnabledDuringInitialization; // @synthesize wasEnabledDuringInitialization=_wasEnabledDuringInitialization;
@property(readonly, nonatomic) BOOL isNetworkRequestPending; // @synthesize isNetworkRequestPending=_isNetworkRequestPending;
...
- (BOOL)isEventBundledAfterRoll:(int)arg1;
- (BOOL)canEventBeSampled:(id)arg1;
...
- (void)swapBackgroundTaskWithNewTaskID:(unsigned int)arg1;
...
- (void)userPropertiesIncludingInternal:(BOOL)arg1 callback:(CDUnknownBlockType)arg2;
...
- (BOOL)shouldWipeDataWithAppID:(id)arg1 appIDFromGMP:(id)arg2 appIDFromAdMob:(id)arg3 persistedAppIDFromGMP:(id)arg4 persistedAppIDFromAdMob:(id)arg5;
- (void)setEnabledOnWorkerQueue:(BOOL)arg1;
- (void)dealloc;
- (BOOL)shouldEnableMeasurement;
- (id)initWithDatabaseName:(id)arg1 persistedConfig:(id)arg2 network:(id)arg3 scheduler:(id)arg4 alarm:(id)arg5 appID:(id)arg6 isAnalyticsCollectionEnabled:(BOOL)arg7 isAnalyticsCollectionDeactivated:(BOOL)arg8 safelistedEvents:(id)arg9;
- (id)initWithAppID:(id)arg1 isAnalyticsCollectionEnabled:(BOOL)arg2 isAnalyticsCollectionDeactivated:(BOOL)arg3 safelistedEvents:(id)arg4;
