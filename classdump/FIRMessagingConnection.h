...
#import "FIRMessagingSecureSocketDelegate.h"
...
- (id)initWithAuthID:(id)arg1 token:(id)arg2 host:(id)arg3 port:(unsigned int)arg4 runLoop:(id)arg5 rmq2Manager:(id)arg6 fcmManager:(id)arg7;
